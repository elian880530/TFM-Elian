...
#Para K=3 el Accuracy: 54%
knn = KNeighborsClassifier(n_neighbors=3)

#Para K=5 el Accuracy: 40.5%
#knn = KNeighborsClassifier(n_neighbors=5)

#Para K=7 el Accuracy: 38%
...
score = knn.score(x_test_img, y_test)
print(score * 100)
...
all_sample_title = 'K Nearest Neighbors - Accuracy Score: {0}'.format(score)
...
MODEL_DIR = './modelos/model-KNN-PCA'

#En la siguiente linea guardamos el primer modelo
pickle.dump(knn, open(MODEL_DIR, 'wb'))
