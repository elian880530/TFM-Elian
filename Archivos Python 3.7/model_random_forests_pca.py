...
#98
#clf_cv = RandomForestRegressor(n_estimators=20, random_state=0)
#98
#clf_cv = RandomForestRegressor(n_estimators=30, random_state=0)
#98
#clf_cv = RandomForestRegressor(n_estimators=40, random_state=0)
#98
clf_cv = RandomForestRegressor(n_estimators=50, random_state=0)
...
regressor.fit(x_train_img, y_train)

#Realizamos la prediccion
y_pred = regressor.predict(x_test_img)
...
MODEL_DIR = './modelos/model-RF-PCA'
