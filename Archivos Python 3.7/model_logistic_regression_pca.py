...
logisticRegr.fit(x_train_img, y_train)

#Make predictions on entire test data
predictions = logisticRegr.predict(x_test_img)

#Use score method to get accuracy of model
# 61% de accuracy
score = logisticRegr.score(x_test_img, y_test)
print(score * 100)
...
MODEL_DIR = './modelos/model-LR-PCA'
